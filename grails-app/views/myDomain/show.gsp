...
<html>
    ...
    <body>
        ...
        <div id="show-myDomain" class="content scaffold-show" role="main">
            ...
            <f:display bean="myDomain" />
            <g:form resource="${this.myDomain}" method="DELETE">
                <fieldset class="buttons">
                    <g:link class="edit" action="edit" resource="${this.myDomain}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
